          ...
          <Section label="Job Info">
            <div className="grid grid-cols-2 gap-4">
              ...
              <Select
                ...
                value={jobCategory}
                onChange={(value) => { setJobCategory(value as string); setField("category", value as string); }}
              >
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <Select
                ...
                value={currency}
                onChange={(value) => { setCurrency(value as string); setField("currency", value as string); }}
              >
