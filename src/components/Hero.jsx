	...
	return (
		<section className="relative isolate overflow-hidden bg-[#050505] text-white  pt-10">
			...
			<div className="pointer-events-none absolute inset-x-0 bottom-[-12vw] flex justify-center sm:bottom-[-15vw] lg:bottom-[-35vw]">
				<div
					className="relative aspect-square w-[132vw] max-w-350 sm:w-[126vw] lg:w-[120vw]"
				>
					<div
						className="absolute inset-[7%] flex items-center justify-center opacity-92"
					>
						<Image
							src={globeImage}
							alt="Animated globe"
					...
					{/* <div
						className="absolute top-150 inset-x-[2%] bottom-[2%] h-[34%] rounded-full bg-[radial-gradient(circle_at_center,rgba(106,86,255,0.98)_0%,rgba(106,86,255,0.62)_22%,rgba(106,86,255,0.22)_46%,rgba(106,86,255,0.08)_64%,transparent_82%)] blur-3xl"
					/> */}
